...
contract Crowdsale is owned {
    ...
    uint public constant startTime =    1510102236; //Wednesday, November 8, 2017 12:50:36 AM
    // 1510056000; // start at 07 NOV 2017 07:00:00 EST
    uint public constant endTime =  1510188636; //  Thursday, November 9, 2017 12:50:36 AM
...
//        require(now < startTime);
    ...
    function() external canBuy payable {
        ...
        token.mint(this, givenTokens);
        token.transfer(msg.sender, givenTokens);
